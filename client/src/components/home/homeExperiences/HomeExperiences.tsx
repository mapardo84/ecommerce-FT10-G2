...
export const HomeExperiences = () => {
    ...
    return (
        <div data-aos="fade" data-aos-once="true" data-aos-duration="1000" className='containerHomeExperiences'>
            <Carousel dotPosition="right" {...settings}>
                ...
                <div className='img-text-HomeExperiences' >
                    ...
                    <img className='imgExperience' src={wedding} alt='owww not found :(' />
                </div>
                <div className='img-text-HomeExperiences'>
                    <div className='containerWordsExperiences'>
                    ...
                    <img className='imgExperience' src={events} alt='owww not found :(' />
                </div>
                <div className='img-text-HomeExperiences'>
                    <div className='containerWordsExperiences'>
                    ...
                    <img className='imgExperience' src={diving} alt='owww not found :(' />
                </div>
            </Carousel>
