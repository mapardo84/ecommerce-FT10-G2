...
export function PaxForm() {
    ...
    // const [boonkingInfo, setBoonkingInfo] = useState({})
    ...
    const onChange=async(value:any,allvalues:any)=>{
        ...
        console.log(boonkingInfo)
        await localStorage.setItem("Henry",JSON.stringify(boonkingInfo))
        setMp(true)
    }
        ...
        <div className='paxForm_container'>
            ...
            <div className='form'>
                ...
                >
                    ...
                    <Form.Item className="mercado_pago">
                            {mp?<MercadoPago/>:null}
                    </Form.Item>
