import { Breadcrumb, Layout, Menu, Row, Divider, Col } from 'antd';
...
export const NavBar = () => {
  return (
    <>
      ...
      <Header className="laclande">
        <Row className="header" justify="center">
          <Col xs={13}>
            <img className="imagen" src="./hotel.png" alt="no funca bro"/>
          </Col>
          <Col xs={10}>
            <Menu className="laclande" theme="dark" mode="horizontal" defaultSelectedKeys={['2']}>              
